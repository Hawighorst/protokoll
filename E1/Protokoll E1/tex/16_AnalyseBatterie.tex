...
Die gemessenen Widerstände bestätigen, innerhalb der $2\sigma$-Umgebung, die theoretischen Erwartungen. Die Größenordnung der Widerstände ist plausibel, da der vorgeschaltete "Innenwiderstand" laut Hersteller $\SI{18.0+-1.8}{\ohm}$ und der tatsächliche Innenwiderstand in der in der Größenordnung $\SI{40}{\milli \ohm}$ liegt \cite{battanl}. %Quelle!!!
