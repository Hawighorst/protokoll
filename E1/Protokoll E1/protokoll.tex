...
\input{tex/10_Zusammenfassung.tex}
\input{tex/15_MethodenBatterie.tex}
\input{tex/16_AnalyseBatterie.tex}
\input{tex/17_MethodenWiderstand.tex}
\input{tex/18_AnalyseWiderstand.tex}
\input{tex/11_MethodenSpule.tex}
\input{tex/13_AnalyseSpule.tex}
%\input{tex/12_MethodenKondensator.tex}
\input{tex/14_AnalyseKondesator.tex}
