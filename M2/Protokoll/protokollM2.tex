...
\input{tex/11_Methoden.tex}
\input{tex/12_Einzelschwingung.tex}
\input{tex/13_Gleich.tex}
\input{tex/14_Gegenlaeufig.tex}
\input{tex/15_Schwebung.tex}
\input{tex/16_Federkonstante.tex}
\input{tex/17_Doppelpendel.tex}
