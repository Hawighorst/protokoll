...
%\input{tex/name.tex}
\input{tex/13_MethodeFallrad.tex}
\input{tex/15_AuswertungFallrad.tex}
\input{tex/16_MethodeKreisel.tex}
\input{tex/18_UnsicherheitKreisel.tex}
\input{tex/17_AuswertungKreisel.tex}
